...
class CloudinaryUploadWidget extends Component {
  constructor(props) {
    ...
    this.newCompanyData = props.newCompanyData;
    this.setNewCompanyData = props.setNewCompanyData;
  }
  ...
  render() {
    return (
      <button type="button" id={`upload_widget-${this.name}`}>
